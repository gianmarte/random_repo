			...
			if(promotions && promotions.length)
			{
				...
				,	item_isbackorderable = free_gift.eligible_items[0].is_backorderable;
					...
					else if (quantity_to_add < 0 && free_gift.added_quantity > 0)
					{
						...
						,	quantity_to_remove = free_gift.added_quantity - quantity_to_add*-1
						,	free_gift_line;
						...
						if(free_gift_line){
							ModelsInit.order.updateItemQuantity({'orderitemid': free_gift_line.internalid.toString(), 'quantity': quantity_to_remove});
						}
					}
				}
