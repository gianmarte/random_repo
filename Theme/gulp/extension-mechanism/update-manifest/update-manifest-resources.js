		...
		case 'renamed':
			...
			if(data.manifest.skins)
			{
				...
				if(_.indexOf(skins, data.file_path) < 0)
				{
					...
					gutil.log(gutil.colors.yellow('Adding skin ' + data.file_path + ' to the manifest file. You should edit the manifest after it and add a proper name for this skin.'));
				}
			}
			else
			{
