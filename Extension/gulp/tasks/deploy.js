...
if(nconf.get('extensionMode'))
{
	gulp.task('extension:deploy'
		...
		, {
			...
			,	'source': 'Comma separated list of resources to deploy. Possible values: templates,sass,ssp-libraries,services,assets,configuration.'
...
else
{
	gulp.task('theme:deploy'
		...
		, {
			...
			,	'source': 'Comma separated list of resources to deploy. Possible values: templates,sass,assets,skins.'
